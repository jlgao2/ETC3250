...
The maximal margin hyperplane is only affected by the support vectors, therefore unless observation 4 moves to within the margin of the classifer, it will not change the maximal margin hyperplane
...
It is not taking a random sample, but rather a convinience sample. 
...
head(summary(c_boost, plotit=TRUE), 6)
```
```{r}
